...
import { sendSms, getSmsLogs, createSmsTemplate, getSmsTemplates, updateSmsTemplate, deleteSmsTemplate, subscribeSms, getSmsSubscriptions, unsubscribeSms, getSmsStats } from '../controllers/smsController.js';
const router = Router();
// Public routes
